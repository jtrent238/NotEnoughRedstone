package com.jtrent238.moreredstone.blocks;
...
import com.jtrent238.moreredstone.BlockLoader;
...
public class BlockRedstoneTorch_blue extends BlockTorch
{
    ...
    private boolean func_150111_a(World p_150111_1_, int p_150111_2_, int p_150111_3_, int p_150111_4_, boolean p_150111_5_)
    {
        ...
        if (p_150111_5_)
        {
            list.add(new BlockRedstoneTorch_blue.Toggle(p_150111_2_, p_150111_3_, p_150111_4_, p_150111_1_.getTotalWorldTime()));
        }
        ...
        {
        	BlockRedstoneTorch_blue.Toggle toggle = (BlockRedstoneTorch_blue.Toggle)list.get(i1);
    ...
    public BlockRedstoneTorch_blue(boolean p_i45423_1_)
    {
    ...
    public void updateTick(World p_149674_1_, int p_149674_2_, int p_149674_3_, int p_149674_4_, Random p_149674_5_)
    {
        ...
        while (list != null && !list.isEmpty() && p_149674_1_.getTotalWorldTime() - ((BlockRedstoneTorch_blue.Toggle)list.get(0)).field_150844_d > 60L)
        {
            list.remove(0);
        }
        ...
        if (this.field_150113_a)
        {
            if (flag)
            {
                p_149674_1_.setBlock(p_149674_2_, p_149674_3_, p_149674_4_, BlockLoader.BlockRedstoneTorch_blue_unlit, p_149674_1_.getBlockMetadata(p_149674_2_, p_149674_3_, p_149674_4_), 3);
                ...
                if (this.func_150111_a(p_149674_1_, p_149674_2_, p_149674_3_, p_149674_4_, true))
                {
                    ...
                    for (int l = 0; l < 5; ++l)
                    {
                        double d0 = 0x0000CD/*/(double)p_149674_2_ + p_149674_5_.nextDouble() * 0.6D + 0.2D/*/;
                        double d1 = 0x0000CD/*/(double)p_149674_3_ + p_149674_5_.nextDouble() * 0.6D + 0.2D/*/;
                        double d2 = 0x0000CD/*/(double)p_149674_4_ + p_149674_5_.nextDouble() * 0.6D + 0.2D/*/;
        ...
        {
            p_149674_1_.setBlock(p_149674_2_, p_149674_3_, p_149674_4_, BlockLoader.BlockRedstoneTorch_blue, p_149674_1_.getBlockMetadata(p_149674_2_, p_149674_3_, p_149674_4_), 3);
        }
    }
    ...
    {
        return Item.getItemFromBlock(BlockLoader.BlockRedstoneTorch_blue);
    }
    ...
    public void randomDisplayTick(World p_149734_1_, int p_149734_2_, int p_149734_3_, int p_149734_4_, Random p_149734_5_)
    {
        if (this.field_150113_a)
        {
            ...
            double d0 = 0x0000CD/*/(double)((float)p_149734_2_ + 0.5F) + (double)(p_149734_5_.nextFloat() - 0.5F) * 0.2D/*/;
            double d1 = 0x0000CD/*/(double)((float)p_149734_3_ + 0.7F) + (double)(p_149734_5_.nextFloat() - 0.5F) * 0.2D/*/;
            double d2 = 0x0000CD/*/(double)((float)p_149734_4_ + 0.5F) + (double)(p_149734_5_.nextFloat() - 0.5F) * 0.2D/*/;
            double d3 = 0x0000CD/*/0.2199999988079071D/*/;
            double d4 = 0x0000CD/*/0.27000001072883606D/*/;

            if (l == 1)
            {
                p_149734_1_.spawnParticle("bluedust", d0 - d4, d1 + d3, d2, 0.0D, 0.0D, 0.0D);
            }
            else if (l == 2)
            {
                p_149734_1_.spawnParticle("bluedust", d0 + d4, d1 + d3, d2, 0.0D, 0.0D, 0.0D);
            ...
            {
                p_149734_1_.spawnParticle("bluedust", d0, d1 + d3, d2 - d4, 0.0D, 0.0D, 0.0D);
            }
            else if (l == 4)
            {
                p_149734_1_.spawnParticle("bluedust", d0, d1 + d3, d2 + d4, 0.0D, 0.0D, 0.0D);
            ...
            {
                p_149734_1_.spawnParticle("bluedust", d0, d1, d2, 0.0D, 0.0D, 0.0D);
            }
        }
    }
    ...
    {
        return p_149667_1_ == BlockLoader.BlockRedstoneTorch_blue_unlit || p_149667_1_ == BlockLoader.BlockRedstoneTorch_blue;
    }
